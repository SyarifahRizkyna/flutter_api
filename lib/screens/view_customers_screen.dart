...
class _ViewCustomersScreenState extends State<ViewCustomersScreen> {
  ...
  Future<void> fetchCustomers() async {
    final response = await http.get(Uri.parse('http://127.0.0.1:8000/customers'));
    ...
    if (response.statusCode == 200) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Gagal mengambil data pelanggan!')));
    }
  }
